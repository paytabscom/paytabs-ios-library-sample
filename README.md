...
| Property                   | Usage                                                                                 |
|----------------------------|---------------------------------------------------------------------------------------|
| profileID                  | Merchant Profile ID, you can get it from your dashboard                               |
| serverKey                  | Merchant Server key, you can get it from your dashboard                               |
| clientKey                  | Merchant Client key, you can get it from your dashboard                               |
| transactionType            | specify if it's a sale or auth transaction                                            |
| TransactionClass           | specify if it's a recurring or ecommerce transaction                                  |
| cartID                     | this is echoed back to you                                                            |
| currency                   | transaction currency                                                                  |
| amount                     | transaction amount                                                                    |
| cartDescription            | description for the transaction by the merchant                                       |
| languageCode               | the language for the payment page                                                     |
| theme                      | use this to customize your payment view, for more details                             |
| forceShippingInfo          | Boolean to indicate if shipping info is Mandatory                                     |
| showBillingInfo            | Boolean to show the billing fields in payment screen                                  |
| showShippingInfo           | Boolean to show the shipping fields in payment screen                                 |
| billingDetails             | user billing info                                                                     |
| shippingDetails            | user shipping info                                                                    |
| merchantIdentifier         |                                                                                       |
| paymentNetworks            | ApplePay supported payment networks                                                   |
| merchantCountryCode        | the country code for the merchant                                                     |
| serverIP                   |                                                                                       |
| tokeniseType               | specify if the tokenisation is optional or mandatory or no tokenisation               |
| tokenFormat                | specify the format of the token i.e (hex32, alphaNum32, ....)                         |
| token                      | the user's saved card token                                                           |
| transactionReference       | A unique key for the transaction generated by the payment gateway.                    |
| screenTitle                | the title that'll be shown in payment page                                            |
| merchantName               | the name of the merchant will be shown in apple pay                                   |
| hideCardScanner            | Boolean to hide the camera card scanner button                                        |
| simplifyApplePayValidation | only validate necessary fields (name, phone, email)                                   |
| linkBillingNameWithCard    | add the billing name as card holder name                                              |
| alternativePaymentMethods  | add other payment method like STCPay, OmanNet, KNet, Valu, Fawry, UnionPay, and Meeza |
