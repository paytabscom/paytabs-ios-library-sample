...
```ogdl
github "paytabscom/paytabs-ios-library-sample" ~> 6.6.21
```
...
```ruby
dependencies: [
    .package(url: "https://github.com/paytabscom/paytabs-ios-library-sample.git", .upToNextMajor(from: "6.6.21"))
]
```
