...
SWIFT_PROTOCOL("_TtP10PaymentSDK18PaymentSDKDelegate_")
@protocol PaymentSDKDelegate
- (void)paymentSDKWithDidFinishTransaction:(PaymentSDKTransactionDetails * _Nullable)transactionDetails error:(NSError * _Nullable)error;
@optional
- (void)paymentSDKWithDidRecieveValidation:(NSError * _Nullable)error;
- (void)paymentSDKWithDidCancelPayment:(NSError * _Nullable)error;
- (void)paymentSDKWithDidStartPaymentTransaction:(UIViewController * _Nonnull)rootViewController;
@end
