...
SWIFT_CLASS_NAMED("DownloadManager") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC10PaymentSDK12STPAPIClient") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC10PaymentSDK18STPAnalyticsClient") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC10PaymentSDK18STPTelemetryClient") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC10PaymentSDK9StripeAPI") SWIFT_AVAILABILITY(ios,introduced=13.0)
